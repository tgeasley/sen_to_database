...
It will download all the relevant Capitulo IV's to the indicated `PUBLIC_FILE_STORAGE` it will then format them and push them to the indicated database as table called `CAPITULO_IV`, or if this table already exists, it will update it.
